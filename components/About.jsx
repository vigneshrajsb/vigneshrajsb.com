...
const About = () => {
  return (
    <div
      id="about"
      className="w-full md:h-screen p-2 flex items-center py-16 bg-gray-800"
    >
      <div className="=max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 text-slate-200">
        <div className="col-span-2">
          ...
          <p className="py-2 text-slate-200 font-medium">
          ...
          <Link href="/#skills">
            <p className="py-2 text-slate-200 underline cursor-pointer">
              See what I can do
            </p>
          </Link>
        </div>
