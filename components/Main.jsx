...
export const Main = () => {
  return (
    <div id="home" className="w-full h-screen text-center bg-[#222] relative">
      <div className="max-w-[1240p] w-full h-full mx-auto p-2 flex justify-center items-center hover:cursor-default">
        <div>
          ...
          <h1 className="py-2 md:py-4 text-[#d4d4d4]  md:hover:scale-125 ease-in duration-500">
            Hi, I&apos;m <span className="text-[#e06e4d] "> Vignesh</span>
          </h1>
          <h2 className="py-1 md:py-2 text-[#d4d4d4]">Software Engineer</h2>
          <p className="py-0 md:py-1 text-[#d4d4d4] font-light">(he/him)</p>
          <p className="py-2 md:py-4 text-[#d4d4d4] max-w-[70%] m-auto  font-light text-sm md:text-base">
          ...
          <div className="flex items-center justify-between max-w-[330px] m-auto py-2 md:py-4">
            <a
